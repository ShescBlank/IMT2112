...
int main(int argc, char *argv[])
{
    ...
    const unsigned int size_chunk = 4;
    ...
    clSetKernelArg(kernel_reduce, 2, sizeof(unsigned int), (void *)&size_chunk);
    clSetKernelArg(kernel_reduce, 3, sizeof(int) * size_group, NULL);
    clSetKernelArg(kernel_reduce, 4, sizeof(cl_mem), (void *)&d_partial_sums);
